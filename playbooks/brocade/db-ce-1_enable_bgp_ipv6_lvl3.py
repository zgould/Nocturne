...
command3 = "no neighbor 2001:1900:2100::2779 shutdown"
db_ce_1 = "10.10.3.16"
...
transport = generic(host=db_ce_1, username="config", enable="B4nkD4t4",
...
if transport.connected:
    print transport.read("show ipv6 bgp summary | b Address", return_type="string")
